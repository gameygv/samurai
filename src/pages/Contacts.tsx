      ...
      <div className="max-w-[1800px] mx-auto space-y-6 pb-24 animate-in fade-in duration-500">
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          ...
          <div className="flex gap-2 items-center flex-wrap">
            <Button onClick={() => setIsManageGroupsOpen(true)} variant="outline" className="border-[#333336] bg-[#121214] text-slate-300 hover:bg-[#161618] h-11 rounded-xl font-bold uppercase tracking-widest text-[10px]">
               <Settings className="w-4 h-4 mr-2" /> Grupos
            </Button>
            <Button onClick={handleRunMassAnalysis} disabled={analyzing} variant="outline" className="border-indigo-500/30 text-indigo-400 hover:bg-indigo-900/40 h-11 rounded-xl font-bold uppercase tracking-widest text-[10px]">
