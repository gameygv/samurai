...
export const BrainHealthCard = ({ health }: BrainHealthCardProps) => {
  const getStatusBadgeVariant = () => {
    switch (health.overallStatus) {
      case 'Operational': return 'bg-green-600/20 text-green-400 border-green-500/30';
      case 'Degraded': return 'bg-yellow-600/20 text-yellow-400 border-yellow-500/30';
      case 'Sync Required': return 'bg-red-600/20 text-red-400 border-red-500/30';
