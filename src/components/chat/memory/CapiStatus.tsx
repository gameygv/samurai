...
export const CapiStatus = ({ healthScore, healthPercent, onRunAnalysis, analyzing }: CapiStatusProps) => (
  <div className="p-4 bg-slate-950/50 border-b border-slate-800 flex justify-between items-center shrink-0">
    <div className="flex flex-col">
      <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Event Match Quality (CAPI)</span>
    ...
    <Button 
      variant="outline" 
      size="sm" 
      className="h-8 gap-2 text-[9px] font-bold border-indigo-500/30 text-indigo-400 hover:bg-indigo-900/20 rounded-lg" 
